(() => {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function menu() {
            const link1 = document.getElementById("menu__link1");
            if (link1) {
                const menuBody = document.querySelector(".menu__body");
            ...
            const link2 = document.getElementById("menu__link2");
            if (link2) {
                const menuBody = document.querySelector(".menu__body");
            ...
            const link3 = document.getElementById("menu__link3");
            if (link3) {
                const menuBody = document.querySelector(".menu__body");
            ...
            const link4 = document.getElementById("menu__link4");
            if (link4) {
                const menuBody = document.querySelector(".menu__body");
